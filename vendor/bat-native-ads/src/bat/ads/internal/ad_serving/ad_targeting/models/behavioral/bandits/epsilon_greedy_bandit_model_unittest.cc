...
TEST_F(BatAdsEpsilonGreedyBanditModelTest,
  ...
  std::string segment_1 = "travel";
  processor.Process({segment_1, AdNotificationEventType::kDismissed});
  std::string segment_2 = "personal finance";
...
TEST_F(BatAdsEpsilonGreedyBanditModelTest,
  ...
  scoped_feature_list.InitAndEnableFeatureWithParameters(
      features::kEpsilonGreedyBandit, {
          // TODO(Moritz Haller): Add strings to _values and rename everywhere
          {"epsilon_value", "0.0"}});
